...
<head>
    ...
    <title>Admin Panel - Destination</title>
        ...
        <div class="row">
            <div class="col-12 p-4 overflow-hidden">
                ...
                <?php 
                    ...
                    if(file_exists('destination_crud.php')) {
                        require('destination_crud.php');
                    } else {
                        echo '<div class="alert alert-info">Welcome to Crud Destination</div>';
                    }
                ?>
            </div> 
        </div>
